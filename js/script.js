                        ...
                        <div class="card p-1 d-flex flex-row gap-3 border-0">
                            ...
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span class="display-4 fs-5 text-secondary">Total: Rs20</span>
                                </div>
                                <div class="d-flex gap-2">
                                    <div class="input-group">
                                        <button class="input-group-text btn btn-sm btn-primary text-white"><i class="bi bi-dash"></i></button>
                                        <input type="number" min="1" value="${addToCartData[i].qty}" class="form-control form-control-sm text-center">
                                        <button class="input-group-text btn btn-sm btn-primary text-white"><i class="bi bi-plus"></i></button>
                                    </div>
